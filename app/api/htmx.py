...
def get_feeds_list(
                ...
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-sm btn-outline-danger"
                                ...
                                hx-confirm="Feed wirklich löschen?">
    ...
    if not html:
        html = '<div class="alert alert-info">Keine Feeds gefunden.</div>'
...
def get_items_list(
    ...
    if not html:
        html = '<div class="alert alert-info">Keine Artikel gefunden.</div>'
...
def get_feed_health_modal(feed_id: int, session: Session = Depends(get_session)):
    ...
    html = f"""
    <h5>Health Status für: {feed.title or 'Untitled Feed'}</h5>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm">
                            ...
                            <button class="btn btn-outline-danger"
                                    ...
                                    hx-confirm="Configuration wirklich löschen?">
                                <i class="bi bi-trash"></i>
                            </button>
                        </div>
                    </td>
        ...
        html += """
            <tr>
                <td colspan="5" class="text-center text-muted">
                    Keine Processor-Konfigurationen gefunden.
                </td>
            </tr>
        """
    ...
    if templates:
                    ...
                    <div class="card-footer">
                        <div class="btn-group btn-group-sm w-100">
                            ...
                            <button class="btn btn-outline-danger"
                                    ...
                                    hx-target="#processor-templates"
                                    hx-confirm="Template wirklich löschen?">
                                <i class="bi bi-trash"></i>
                            </button>
                            '''}
                        </div>
        ...
        <div class="col-12">
            <div class="alert alert-info text-center">
                ...
                Keine Processor-Templates gefunden.
            </div>
        </div>
        """
    ...
    <form hx-put="/api/feeds/{feed.id}" hx-target="#feeds-list"
        ...
        <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control-plaintext">
                            <span class="badge bg-{'success' if feed.status.value == 'active' else 'warning' if feed.status.value == 'inactive' else 'danger'}">
                                {'Aktiv' if feed.status.value == 'active' else 'Inaktiv' if feed.status.value == 'inactive' else 'Fehler'}
                            </span>
                            <small class="text-muted ms-2">(Wird automatisch gesetzt)</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Letzter Abruf</label>
                        <input type="text" class="form-control" value="{feed.last_fetched or 'Nie'}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
