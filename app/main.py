...
from app.web.views import analysis, auto_analysis_views, manager_views, special_report_views, admin_views, feed_views, research_views, scraper_views
...
app.include_router(scraper_views.router)  # Scraper Test UI
