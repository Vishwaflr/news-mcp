...
### GET /htmx/htmx/analysis/active-runs
...
### GET /htmx/htmx/analysis/feeds-list-options
...
### GET /htmx/htmx/analysis/history
**Get History Partial**
...
### GET /htmx/htmx/analysis/monitoring
...
### GET /htmx/htmx/analysis/presets
**Get Presets Partial**
...
### GET /htmx/htmx/analysis/quick-actions
